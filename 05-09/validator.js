...
//     if(txt_lastname.value.length < name_min_len) {
//         txt_lastname.style.backgroundColor = "red";
//     }

//     if(txt_lastname.value.length > name_max_len) {
//         txt_ntxt_lastname.style.backgroundColor = "red";
//     }
// }